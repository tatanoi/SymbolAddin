...
(function () {
    ...
    function test() {
        ...
        //    //    write("Action failed with error: " + asyncResult.error.message);
        //    //}
        //    //else {
        ...
        //Office.select("binding#MyTableBinding").setDataAsync("Hello", null, function (result) {
        //    if (result.status == Office.AsyncResultStatus.Succeeded) {
        //        Office.context.document.goToByIdAsync("MyTableBinding", Office.GoToType.Binding, function (asyncResult) {
        //            Office.context.document.bindings.releaseByIdAsync("MyTableBinding");
        //        });
        //    }
        //});
        ...
        //Word.run(function (context) {
        //    var range = context.document.getSelection();
        //    range.insertText("Hello", Word.InsertLocation.start);
        //    range.font.name = "tahomaxy";
        //    return context.sync();
        //})
        //    .catch(errorHandler);
        window.location = "http://symbolindex.azurewebsites.net/";
    }
